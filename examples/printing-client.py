...
def run():
    ...
    credentials = google_auth_jwt.Credentials.from_service_account_file(
        '../../../.infostellar/stellarstation-private-key.json',
    ...
    channel_credential = grpc.ssl_channel_credentials(
        open('../stellarstation-api/examples/fakeserver/src/main/resources/tls.crt', 'br').read())
...
# This generator yields the requests to send on the stream opened by
# OpenSatelliteStream.
# The client side of the stream will be closed when this generator returns (in
# this example, it never returns).
